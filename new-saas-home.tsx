/**
 * v0 by Vercel.
 * @see https://v0.dev/t/vKXDAOIRgqg
    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 border-t">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Call-to-Action (CTA)</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Prominent CTA button with text "Start Free Trial". Encourage visitors to sign up for a free trial with a
                brief description of what they'll get.
              </p>
              <Button className="bg-gray-900 text-gray-50 px-8 py-3 rounded-md shadow hover:bg-gray-900/90 focus:outline-none focus:ring-1 focus:ring-gray-950">
                Start Free Trial
              </Button>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">How It Works Section</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Step-by-step explanation of how CloudBoost works. Use icons or illustrations to visually represent each
                step.
              </p>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Pricing Section</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Clear pricing plans with features listed for each plan. Highlight the recommended plan with a "Most
                Popular" badge.
              </p>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">FAQ Section</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Answer common questions about CloudBoost. Use accordion or dropdowns for easy navigation.
              </p>
            </div>
          </div>
        </section>
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Footer Section</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Contact information and social media links. Links to privacy policy, terms of service, and support.
              </p>
            </div>
          </div>
        </section>
